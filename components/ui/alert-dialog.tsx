...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // inset-x-4 + max-w + centered translate keeps a comfortable margin on
        // narrow phones instead of running edge-to-edge like the desktop dialog.
        "fixed left-1/2 top-1/2 z-50 grid w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 gap-4",
        "max-h-[85vh] overflow-y-auto rounded-2xl border bg-card p-6 shadow-glass",
