...
export default async function NewTrainerMemberPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {/* Trainers have no standalone members list -- land back on "My Clients"
          after a successful save, same as the list Trainers actually use. */}
      <MemberForm basePath="/dashboard/trainer/clients" plans={plans} trainers={trainers} />
    </div>
  );
}